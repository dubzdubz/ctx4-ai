    ...
    <div className="flex min-h-screen flex-col">
      ...
      <header className="flex flex-col items-center gap-6 px-6 pt-12 pb-16 text-center">
        ...
        <p className="max-w-lg text-lg text-muted-foreground">
          A starter template for building authenticated MCP servers with
          Next.js and Supabase. Ship tools that AI clients can discover and
          call&mdash;with OAuth&nbsp;2.1 built&nbsp;in.
        </p>
